 ...
 */
export async function createCheckoutSession(params: CreateCheckoutParams): Promise<{ id: string; url: string | null }> {
  ...
  const lineItems: Stripe.Checkout.SessionCreateParams.LineItem[] = env.STRIPE_SETUP_FEE_PRICE_ID
