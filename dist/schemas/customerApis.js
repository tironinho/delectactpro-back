...
export const createCustomerApiSchema = customerApiBaseSchema.refine((d) => (d.authType === 'HMAC' ? !!d.sharedSecret : true) && (d.authType === 'BEARER' ? !!d.bearerToken : true), { message: 'sharedSecret required for HMAC; bearerToken required for BEARER' });
